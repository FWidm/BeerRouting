...
public class TextOutline : MonoBehaviour
{
    ...
    public void AdjustSortingLayerOrderOfOutlineRenderer()
    {
        // Debug.Log("*** Sorting layer id of main renderer is: " + meshRenderer.sortingLayerID + " and sorting order is: " + meshRenderer.sortingOrder);
        // Get the current sorting layer of the main mesh renderer.
        otherMeshRenderer.sortingLayerID = meshRenderer.sortingLayerID;
        otherMeshRenderer.sortingLayerName = meshRenderer.sortingLayerName;
